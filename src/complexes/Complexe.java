...
/**
 * 
 * represente un nombre complexe z sous forme cartesienne z = x + y*i
 * 
 * utilisee pour tester les junits
 * 
 * dans l'ordre : ecrire d'abord les tests PUIS implementer les methodes
 * 
 * */
...
/**
 * @return la partie reelle de this
 * 
 * */
...
/**
 * 
 * calcule le complexe conjugue de this
 * rappel : si this = x + yi alors this* = x - yi
 * 
 * @return le nombre complexe conjugue de this
 * 
 * */
 ...
 * 
 * @return la norme euclidienne de this (appelee aussi module de this)
 * 
 * */
...
/**
 * @return |this|^2 (c'est-e dire x^2 +y^2)
 * 
 * */
...
/**
 * 
 * calcule les n racines n-iemes de this
 * 
 * rappel : si z = R * e^(i * theta) alors z a n racines n-emes Z0, ..., Zn-1 
 * 
 * telles que Zk = r * e^(i (alfa + k*2* PI/n)) pour 0 <= k <= n-1
 * 
 * oe r = R^(1/n) et alfa = theta/n
 * 
...
/**
 * @return la string composee de la partie reelle et de la partie imaginaire suivant le format classique en maths
 * 
 * Exemple pour this = (3,-5), la string retournee est "3 + -5 * i"
 * 
 * */
